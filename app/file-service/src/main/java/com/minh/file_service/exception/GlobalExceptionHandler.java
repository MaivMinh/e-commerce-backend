...
import com.minh.file_service.response.ResponseError;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ResponseError> handleGlobalException(Exception exception, WebRequest webRequest) {
    ResponseError errorResponse = new ResponseError(HttpStatus.INTERNAL_SERVER_ERROR.value(), webRequest.getDescription(false), exception.getMessage(), LocalDateTime.now());
