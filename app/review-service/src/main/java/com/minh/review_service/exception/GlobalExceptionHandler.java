package com.minh.review_service.exception;

import com.minh.review_service.response.ResponseError;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ResponseError> handleGlobalRuntimeException(RuntimeException exception,
