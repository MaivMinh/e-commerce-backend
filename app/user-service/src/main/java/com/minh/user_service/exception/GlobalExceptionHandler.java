package com.minh.user_service.exception;

import com.minh.user_service.response.ResponseError;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ResponseError> handleGlobalException(RuntimeException exception,
