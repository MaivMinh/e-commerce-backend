...
import com.minh.cart_service.response.ResponseError;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ResponseError> handleCartAlreadyExistsException(CartAlreadyExistsException exception,
                                                                           WebRequest webRequest) {
    ResponseError errorResponse = new ResponseError(
